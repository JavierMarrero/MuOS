...
printf "#ifndef __MEL_KERNEL_CONFIGURATION_H__\n#define __MEL_KERNEL_CONFIGURATION_H__\n\n" >> $hfile

# Write the variables one by one
printf "#define MEL_KERNEL_CONFIG_DEBUG         $CONFIG_DEBUG\n\n" >> $hfile
printf "#define MEL_KERNEL_CONFIG_ANSI_ESCAPES  $CONFIG_ANSI_ESCAPES_ON\n\n" >> $hfile

# Finish writing the ward
printf "#endif\n" >> $hfile
